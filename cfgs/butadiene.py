...
def default() -> ml_collections.ConfigDict:
  cfg = ml_collections.ConfigDict({
    # system
    'mech': 'Aramco_3_0', # mechanism name
    'mechpath': './mechs/Aramco_3_0/Aramco_3_0.yaml', # mechanism filename 
    'fuel': "C4H6", # fuel
    ...
    'n_steps': 200, # simulation step for reactors
    ...
    'n_epochs': 2000, 
    'lambda_1': 0.2, # balance ratio between two objectives
